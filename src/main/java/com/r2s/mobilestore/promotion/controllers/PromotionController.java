...
public class PromotionController {
     ...
     */
    @GetMapping
    public ResponseEntity<?> getAllPromotions(@RequestParam(required = false) String discountCode,
        ...
        try {
            ...
            if (discountCode == null) {
                ...
                //Filter
                promotionList = promotionService.filterByDiscountCode(discountCode, pageNumber, pageSize);
            }
