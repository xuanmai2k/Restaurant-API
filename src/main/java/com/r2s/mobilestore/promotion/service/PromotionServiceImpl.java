...
public class PromotionServiceImpl implements PromotionService {
     ...
     *
     * @param discountCode This is category discount code
     * @param pageNumber   This is number of page
     * @param pageSize     This is size of page
     * @return List of promotions
     */
    @Override
    public Page<Promotion> filterByDiscountCode(String discountCode, int pageNumber, int pageSize) {
        return promotionRepository.findByDiscountCodeContaining(discountCode, PageRequest.of(pageNumber, pageSize));
    }
